...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[var(--background)]">
      ...
      {/* Footer */}
      <footer className="py-6 border-t border-[var(--primary)]/20 bg-[var(--background)]">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <p className="text-sm text-[var(--foreground)]/70">
              © {new Date().getFullYear()} Bruna Villene | Natural Beauty Laser
            </p>
            <div className="mt-4 md:mt-0">
              <p className="text-sm text-[var(--foreground)]/70 flex items-center">
                Desenvolvido por{" "}
                <a 
                  href="https://www.linkedin.com/in/lucasteixeiraamorim/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="ml-1 flex items-center hover:text-[var(--icon-active)] transition-colors duration-300"
                >
                  Lucas Teixeira
